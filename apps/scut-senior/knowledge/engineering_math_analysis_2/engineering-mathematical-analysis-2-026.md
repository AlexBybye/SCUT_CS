---
source_id: engineering-mathematical-analysis-2-026
course_id: engineering_math_analysis_2
title: "2017级工科数学分析期末试卷A"
original_file: "学科资料/工科数学分析II/往年卷/2017级工科数学分析期末试卷A.doc"
...
![image](assets/engineering-mathematical-analysis-2-026/image-001.png)**诚信应考，考试作弊将带来严重后果！**
...
1. 曲线![formula-object](assets/engineering-mathematical-analysis-2-026/image-009.png)在点$(1,\sqrt{3},2)$处的切线方程为                                         ;
...
C.  $xy'''+y''+x^2y=0$;				D.  ![formula-object](assets/engineering-mathematical-analysis-2-026/image-018.png).
1. 二元函数![formula-object](assets/engineering-mathematical-analysis-2-026/image-019.png),  则$\lim_{(x,y)\to(0,0)}f(x,y)$(     )
...
1. 使得级数![formula-object](assets/engineering-mathematical-analysis-2-026/image-038.png)条件收敛的常数$p$的取值范围是(     )
...
3.  计算三重积分$\iiint_\Omega(x^2+y^2+z^2)dxdydz$,  其中![formula-object](assets/engineering-mathematical-analysis-2-026/image-052.png)为球面$x^{2}+y^{2}+z^{2}=2z$围成的区域.

**四、证明题：共1题，每题1分，共8分。**

证明函数项级数$\sum_{n=0}^{\infty}x^{2}e^{-nx}$在![formula-object](assets/engineering-mathematical-analysis-2-026/image-055.png)一致收敛.
...
3.  设曲线积分![formula-object](assets/engineering-mathematical-analysis-2-026/image-063.png)与路径无关,  其中$f(x)$有一阶连续导数且$f(\pi)=1$,  求$f(x)$并计算曲线积分![formula-object](assets/engineering-mathematical-analysis-2-026/image-067.png).
