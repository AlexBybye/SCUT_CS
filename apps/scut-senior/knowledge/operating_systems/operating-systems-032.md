---
source_id: operating-systems-032
course_id: operating_systems
title: "OS模拟"
original_file: "学科资料/操作系统/往年卷/OS模拟4.pdf"
document_role: note
year: 
locator_type: page
---
...
C.就绪态变为运行态
D.等待态变为就绪态
11．如果允许不同用户的文件可以具有相同的文件名，通常采用（）保证按名存取的安全。
A.重名翻译机构
B.建立索引表
C.建立指针
D.多级目录结构
12．一作业进入内存后，则所属该作业的进程初始时处于（）状态。
A.运行
B.等待
C.就绪
D.收容
...
![image](assets/operating-systems-032/image-001.jpeg)
