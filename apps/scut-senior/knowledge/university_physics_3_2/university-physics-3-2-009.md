---
source_id: university-physics-3-2-009
course_id: university_physics_3_2
title: "2023级大学物理2期末复习-填空&选择"
original_file: "学科资料/大物下/往年卷/2023级大学物理2期末复习-填空&选择 -2.pdf"
...
注意面积S或面积元dS的方向：若计算某一面积的
磁通量，只要选择与磁场方向夹角为锐角的法向(垂
直于该面积)作为S的方向；若需计算通电线圈的磁通
量（例如：计算磁力做功），应选择与线圈电流满足
右手螺旋的法向作为S的方向。
...
任意平面载流导线在均匀磁场中所受的力，与其
始点和终点相同的载流直导线所受的磁场力相同。
...
在均匀磁场中，对任一形状的闭合电流回路，不论
是形状改变还是位置改变，磁力或磁力矩作的功都
等于电流与磁通增量的乘积。
...
➢自感：回路中的电流发生变化时，引起自身回路的磁通
量发生变化，从而在回路自身产生感生电动势的现象。
