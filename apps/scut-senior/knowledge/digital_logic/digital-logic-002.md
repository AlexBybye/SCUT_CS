---
source_id: digital-logic-002
course_id: digital_logic
title: "2012级计算机学院数字逻辑试卷 A卷题目"
original_file: "学科资料/数字逻辑/往年卷/2012级计算机学院数字逻辑试卷 A卷题目.doc"
...
![formula-object](assets/assets/digital-logic-002/image-001.png)A．  $\overline {AB}\cdot \overline {(B+C)}$
...
![formula-object](assets/assets/digital-logic-002/image-002.png)

7．8线—3线优先编码器的输入为I0-I7，当有限级别最高的I7有效时，其输出 ![formula-object](assets/assets/digital-logic-002/image-003.png)的值是（        ）。
...
![image](assets/assets/digital-logic-002/image-004.png)
...
![image](assets/assets/digital-logic-002/image-005.png)
...
![image](assets/assets/digital-logic-002/image-006.png)

H=High Level，L=Low Level, X=don’t care, Note 1:  $G2=\overline {G2A}+\overline {G2B}$

![image](assets/assets/digital-logic-002/image-007.png)
1. （12分）分析下图所示同步时序逻辑电路，作出状态转移表和状态图，说明这个电路能对何种序列进行检测？

![image](assets/assets/digital-logic-002/image-008.png)
