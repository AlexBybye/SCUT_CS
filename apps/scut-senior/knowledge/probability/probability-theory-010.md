---
source_id: probability-theory-010
course_id: probability_theory
title: "2020—2021学年第二学期《概率论与数理统计》A卷答案"
original_file: "学科资料/概率论/往年卷/【包打听分享】2021概率统计试卷A-答案19.docx"
...
1. 设随机变量$X$与$Y$相互独立，且均服从区间$[0,3]$上的均匀分布，则![formula-object](assets/probability-theory-010/image-004.png)![formula-object](assets/probability-theory-010/image-005.png)(  ).
...
附：![formula-object](assets/probability-theory-010/image-075.png)

**解**  ![formula-object](assets/probability-theory-010/image-076.png)    (2分)

则![formula-object](assets/probability-theory-010/image-077.png),记$X=\sum_{i=1}^{100}X_i$,则![formula-object](assets/probability-theory-010/image-079.png).   (2分)
...
设随机变量*X*的概率密度为![formula-object](assets/probability-theory-010/image-093.png) 令随机变量 $Y\mathrm {=}\left \{ {\begin {matrix} \mathrm {2,} & X\mathrm {\le 1,} \\ X, & \mathrm {1<}X\mathrm {<2,} \\ \mathrm {1,} & X\mathrm {\ge 2.} \end {matrix}}\right$ (1)  求*Y*的分布函数；      (2)  求概率 $P\mathrm {\{}X\mathrm {\le }Y\mathrm {\} }$.
...
综上     ![formula-object](assets/probability-theory-010/image-094.png)          (1分)
...
求![image](assets/probability-theory-010/image-101.png)的矩估计和最大似然估计.

**解**        ![image](assets/probability-theory-010/image-102.png)

![image](assets/probability-theory-010/image-103.png)

令$3-4\hat{\theta}=2$，解得![image](assets/probability-theory-010/image-105.png)的矩估计$\hat{\theta}_M=\frac{1}{4}$.      (5分)

对于给定的样本值,似然函数为

![image](assets/probability-theory-010/image-107.png)

![image](assets/probability-theory-010/image-108.png)

![image](assets/probability-theory-010/image-109.png)

令![image](assets/probability-theory-010/image-110.png),解得![image](assets/probability-theory-010/image-111.png).因![image](assets/probability-theory-010/image-112.png)不合题意,所以![image](assets/probability-theory-010/image-113.png)的最大似然估计为$\hat{\theta}_L=\frac{7-\sqrt{13}}{12}$.   (5分)
