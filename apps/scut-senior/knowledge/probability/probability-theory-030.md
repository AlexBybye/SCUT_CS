---
source_id: probability-theory-030
course_id: probability_theory
title: "2014春A卷无答案"
original_file: "学科资料/概率论/往年卷/2014春A卷无答案.docx"
...
![formula-object](assets/probability-theory-030/image-003.png)
...
**(1)** 设某机器生产的零件长度（单位：cm）![image](assets/probability-theory-030/image-023.png)，今抽取容量为16的样本，测得样本均值![image](assets/probability-theory-030/image-024.png)，样本方差![image](assets/probability-theory-030/image-025.png). 求![image](assets/probability-theory-030/image-026.png)的置信度为0.95的置信区间.
...
![formula-object](assets/probability-theory-030/image-028.png)
