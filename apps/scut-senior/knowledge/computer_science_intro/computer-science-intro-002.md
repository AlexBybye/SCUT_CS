---
source_id: computer-science-intro-002
...
2. Logic diagrams(逻辑图)
3. Truth tables(真值表)

Types of gate:

![](assets/computer-science-intro-002/image-001.png)

![](assets/computer-science-intro-002/image-002.png)

Transistor(晶体管): 半导体材料制成、可做导线可做电阻、相当于开关

![](assets/computer-science-intro-002/image-003.png)

Combinational Circuits(组合电路): 即类似于分配律等将电路布尔表达式和真值表写出

![](assets/computer-science-intro-002/image-004.png)

![](assets/computer-science-intro-002/image-005.png)
...
![](assets/computer-science-intro-002/image-006.png)
...
![](assets/computer-science-intro-002/image-007.png)
...
1. Code coverage(代码覆盖)【明箱测试】
2. Data coverage(数据覆盖)【暗箱测试】-记忆：dark-data
