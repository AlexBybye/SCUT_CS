...
course_id: cpp
title: B
original_file: "学科资料/C++（上及下）/C++代码合辑(Ai盛行，故停止维护)/第一次代码合辑/B.txt"
document_role: note
year:
locator_type: none
---
