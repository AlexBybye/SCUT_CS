...
- g.1-49表示1~49 50-99表示-50~-1 0表示0
- g.01111111表示127
- 10000000表示-128
...
- Keyword encoding（关键字编码）：quickly
...
- Types of gate:
![](images/computer-science-intro-02/image_001.png)

![](images/computer-science-intro-02/image_002.png)

Transistor(晶体管): 半导体材料制成、可做导线可做电阻、相当于开关

![](images/computer-science-intro-02/image_003.png)

Combinational Circuits(组合电路): 即类似于分配律等将电路布尔表达式和真值表写出

**![](images/computer-science-intro-02/image_004.png)**![](images/computer-science-intro-02/image_005.png)
...
![](images/computer-science-intro-02/image_006.png)
...
![](images/computer-science-intro-02/image_007.png)
